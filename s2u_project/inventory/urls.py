...
urlpatterns = [
    ...
    path("bulk-orders/<int:list_id>/monthly-refresh/start/", views.bulk_order_monthly_refresh_start, name="bulk_order_monthly_refresh_start"),
    path("api/bulk-orders/monthly-refresh/status/", views.bulk_order_monthly_refresh_status, name="bulk_order_monthly_refresh_status"),
